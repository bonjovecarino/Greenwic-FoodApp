...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  _launchURL() async {
    var url = Uri.parse("https://www.greenwichdelivery.com/");
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Row(
                  children: [
                    ClipOval(child: Image.asset("assets/greenwich.png",height: 60,width: 70,)),
                    const SizedBox(width: 10,),
                    Flexible(child: Text("Most loved pizza brand in the Philippines",style:GoogleFonts.mukta(textStyle: TextStyle(fontWeight: FontWeight.bold,
                      color: Theme.of(context).brightness == Brightness.light ? MyColors.darkGreen: Colors.white,
                    )) ))
                  ],
                ) ,
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          ...
                          child: const Text("greenwichdelivery.com",style: TextStyle(color: Colors.blueAccent,decoration: TextDecoration.underline,fontWeight: FontWeight.bold),)),
                    ],
                  ),
                )
              ],
